...
$deletePath = if ($env:KNOWLEDGE_BASE_PATH) { $env:KNOWLEDGE_BASE_PATH } else { "E:\Knowledge\Study\dp_know\undo" }
$searchPath = if ($env:SEARCH_PATH) { $env:SEARCH_PATH } else { "E:\Knowledge\Study\dp_know" }
